...
var Button = (0, _reactLoadable.default)({
  loader: function loader() {
    return requireEnsure('button');
  },
...
function (_Component) {
  ...
  _createClass(Client, [{
    ...
    value: function componentDidMount() {
      ...
      requireEnsure('moment').then(function (m) {
    ...
    value: function render() {
      ...
      }, this.state.count, ": ", this.state.moment === null ? '' : this.state.moment.now()), _react.default.createElement(Button, {
